    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "C:\\Users\\Ramanand\\Downloads\\Attendance-Management-system-using-face-recognition-master\\Attendance-Management-system-using-face-recognition-master\\Attendance\\"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    r'explorer /select,"C:\\Users\\Ramanand\\Downloads\\Attendance-Management-system-using-face-recognition-master\\Attendance-Management-system-using-face-recognition-master\\Attendance\"'
                )
